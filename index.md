...
<div style="display: flex; justify-content: center; align-content: center; flex-direction: column;">
    <p>I am a fifth-year PhD student (😱) in the Department of Computer and Information Science (CIS) at the University of Pennsylvania, where I am advised by <a href="https://www.andrewhead.info">Andrew Head</a>. <b>I study how existing documents can be infused with additional information to make them easier to understand.</b> For example, I have recently focused on <a href="https://dl.acm.org/doi/10.1145/3563657.3596059">how written recipes can be restructured for voice guidance</a>.</p>
